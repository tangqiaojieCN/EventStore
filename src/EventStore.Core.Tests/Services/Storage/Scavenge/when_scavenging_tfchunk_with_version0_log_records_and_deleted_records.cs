...
namespace EventStore.Core.Tests.Services.Storage.Scavenge
{
    ...
    public class when_scavenging_tfchunk_with_version0_log_records_and_deleted_records : ReadIndexTestScenario
    {
        ...
        protected override void WriteTestScenario()
        {
            ...
            _event1 = WriteSingleEventWithLogVersion0(Guid.NewGuid(), _eventStreamId, WriterCheckpoint.ReadNonFlushed(), 0);
            _event2 = WriteSingleEventWithLogVersion0(Guid.NewGuid(), _eventStreamId, WriterCheckpoint.ReadNonFlushed(), 1);
            ...
            _deleted = WriteSingleEventWithLogVersion0(Guid.NewGuid(), _deletedEventStreamId, WriterCheckpoint.ReadNonFlushed(), int.MaxValue, PrepareFlags.StreamDelete | PrepareFlags.TransactionBegin | PrepareFlags.TransactionEnd);

            // Stream that will be kept
            _event3 = WriteSingleEventWithLogVersion0(Guid.NewGuid(), _eventStreamId, WriterCheckpoint.ReadNonFlushed(), 2);
            _event4 = WriteSingleEventWithLogVersion0(Guid.NewGuid(), _eventStreamId, WriterCheckpoint.ReadNonFlushed(), 3);
